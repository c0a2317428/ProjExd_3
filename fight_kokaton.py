...
class Score:
    ...
    def increment_bombs_dropped(self):
        self.bombs_dropped += 1
    
    def get_bombs_dropped(self):
        return self.bombs_dropped

# 使用例
if __name__ == "__main__":
    score = Score()
    score.increment_bombs_dropped()  # 爆弾を1つ増やす
    score.increment_bombs_dropped()  # 爆弾をもう1つ増やす
    print("打ち落とした爆弾の数:", score.get_bombs_dropped())  # 爆弾の数を表示
